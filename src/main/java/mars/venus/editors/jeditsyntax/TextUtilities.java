...
public class TextUtilities {
  /**
   * Returns the offset of the bracket matching the one at the specified offset of the document, or
   * -1 if the bracket is unmatched (or if the character is not a bracket).
   *
