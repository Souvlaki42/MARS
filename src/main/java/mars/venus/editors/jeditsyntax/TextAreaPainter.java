...
public class TextAreaPainter extends JComponent implements TabExpander {
   ...
   *
   * <p>NOTE: as of Java 1.4 this method is deprecated and no longer has the desired effect because
   * the focus subsystem does not call it. I've implemented a KeyEventDispatcher in JEditTextArea to
   * handle Tabs. DPS 12-May-2010
   */
  ...
  /**
   * Set the tab size in characters. DPS 12-May-2010. Originally it was fixed at PlainDocument
   * property value (8).
   *
  ...
  /**
   * Returns true if bracket highlighting is enabled, false otherwise. When bracket highlighting is
   * enabled, the bracket matching the one before the caret (if any) is highlighted.
   */
  ...
  public interface Highlight {
    ...
    /**
     * Returns the tool tip to display at the specified location. If this highlighter doesn't know
     * what to display, it should delegate to the next highlight painter.
     *
  ...
  public final void invalidateLine(int line) {
    repaint(
        0,
        textArea.lineToY(line) + fm.getMaxDescent() + fm.getLeading(),
        getWidth(),
        fm.getHeight());
  }
  ...
  protected void paintLine(
      ...
      int line,
      int x) { // System.out.println("paintLine "+ (++count));
  ...
  protected void paintHighlight(
      Graphics gfx, int line, int y) { // System.out.println("paintHighlight "+ (++count));
