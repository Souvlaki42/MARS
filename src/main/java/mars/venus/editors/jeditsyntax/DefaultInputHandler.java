...
public class DefaultInputHandler extends InputHandler {
   ...
   * key strokes of the form <i>[modifiers+]key</i> where modifier is C for Control, A for Alt, or S
   * for Shift, and key is either a character (a-z) or a field name in the KeyEvent class prefixed
   ...
   * <i>modifiers</i>+<i>shortcut</i> where <i>modifiers</i> is any combination of A for Alt, C for
   * Control, S for Shift or M for Meta, and <i>shortcut</i> is either a single character, or a
   * keycode name from the <code>KeyEvent</code> class, without the <code>VK_</code> prefix.
   *
