 ...
 *
 * <p>Provides those methods required by the MARSTextEditingArea interface that are not defined by
 * JEditTextArea. This permits JEditTextArea to be used within MARS largely without modification.
 * DPS 4-20-2010
 *
 * @since 4.0
 * @author Pete Sanderson
 */
public class JEditBasedTextArea extends JEditTextArea
  ...
  /**
   * Set the caret blinking rate in milliseconds. If rate is 0 will disable blinking. If negative,
   * do nothing.
   *
  ...
  /**
   * Same as setSelectedText but named for compatibility with JTextComponent method
   * replaceSelection. DPS, 14 Apr 2010
   *
  ...
  /**
   * Returns next posn of word in text - forward search. If end of string is reached during the
   * search, will wrap around to the beginning one time.
   *
