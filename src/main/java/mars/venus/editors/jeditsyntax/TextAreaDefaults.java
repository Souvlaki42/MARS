...
public class TextAreaDefaults {
  ...
  public static TextAreaDefaults getDefaults() {
    ...
    DEFAULTS.electricScroll =
        0; // was 3.  Will begin scrolling when cursor is this many lines from the edge.
    ...
    if (DEFAULTS.lineHighlightColor == null) {
      ...
      DEFAULTS.lineHighlightColor =
          new Color(blendRed, blendGreen, blendBlue, LINE_HIGHLIGHT_ALPHA);
    }
    DEFAULTS.lineHighlight =
        mars.Globals.getSettings().getBooleanSetting(Settings.EDITOR_CURRENT_LINE_HIGHLIGHTING);
