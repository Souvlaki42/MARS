...
public class SyntaxDocument extends PlainDocument {
  /**
   * Returns the token marker that is to be used to split lines of this document up into tokens. May
   * return null if this document is not to be colorized.
   */
  ...
  /**
   * Ends a compound edit that can be undone in one operation. Subclasses that implement undo should
   * override this method; this class has no undo functionality so this method is empty.
   */
  public void endCompoundEdit() {}

  /**
   * Adds an undoable edit to this document's undo list. The edit should be ignored if something is
