...
public class Token {
  ...
  /**
   * Literal 2 token id. This can be used to mark an object literal (eg, Java mode uses this to mark
   * true, false, etc)
   */
  ...
  /**
   * Invalid token id. This can be used to mark invalid or incomplete tokens, so the user can easily
   * spot syntax errors.
   */
