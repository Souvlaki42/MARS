...
public class SyntaxStyle {
  ...
  /**
   * Returns the color coded as Stringified 32-bit hex with Red in bits 16-23, Green in bits 8-15,
   * Blue in bits 0-7 e.g. "0x00FF3366" where Red is FF, Green is 33, Blue is 66. This is used by
   * Settings initialization to avoid direct use of Color class. Long story. DPS 13-May-2010
   *
   * @return String containing hex-coded color value.
   */
  public String getColorAsHexString() {
    return mars.util.Binary.intToHexString(
  ...
  /**
   * Sets the foreground color and font of the specified graphics context to that specified in this
   * style.
   *
