...
public class HardcopyWriter extends Writer {
  ...
  /**
   * This is the flush( ) method that all Writer subclasses must implement. There is no way to flush
   * a PrintJob without prematurely printing the page, so we don't do anything.
   */
  public void flush() {
    /* do nothing */
  }
  ...
  /**
   * This is the exception class that the HardcopyWriter constructor throws when the user clicks
   * "Cancel" in the print dialog box.
   */
